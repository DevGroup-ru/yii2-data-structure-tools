...
if (true === $property->canTranslate()) {
    ...
    foreach ($languages as $index => $language) {
        ...
        $items[] = [
            ...
            'active' => $index === 0,
            'content' => Html::label($property->name, $langInputId)
                . Html::textarea($inputName, $value, ['class' => 'form-control', 'rows' => 7, 'id' => $langInputId])
    ...
    echo $form->field($model, $property->key)->textarea(['rows' => 7])->label($property->name);
}
